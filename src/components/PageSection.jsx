    ...
    return (
        <div className="section page">
            <div className="col typography"> 
                ...
                <p className="info">Our mission is to make cooking enjoyable and accessible to everyone. We believe that cooking should be a fun and rewarding experience and our goal is to provide you with the tools, resources and inspiration you need to explore the world of cooking from the comfort of your own kitchen.</p>
